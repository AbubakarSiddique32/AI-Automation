...
const AboutData = () => {
  return (
    <div className="">
      <section id="overview" className=" w-full py-[50px] px-[30px]">
        <h4 className=" font-poppins text-[30px] font-[500] text-center">
      ...
      <section
        id="features"
        className="w-full py-[50px] px-[100px] text-center"
      >
